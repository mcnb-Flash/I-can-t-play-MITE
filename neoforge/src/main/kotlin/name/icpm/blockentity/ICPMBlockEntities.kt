...
object ICPMBlockEntities {
    ...
    /**
     * BlockEntityType构建器（NeoForge：原版 BlockEntityType.Builder）。
     */
    private object BlockEntityTypeBuilder {
        ...
        fun <T : net.minecraft.world.level.block.entity.BlockEntity> create(
            ...
            val supplier = net.minecraft.world.level.block.entity.BlockEntityType.BlockEntitySupplier { p, s -> factory(p, s) }
            // 1.21.11 无 Builder：NeoForge 提供便捷构造 new BlockEntityType(supplier, Block...)
            return net.minecraft.world.level.block.entity.BlockEntityType(supplier, *blocks)
        }
    }
}