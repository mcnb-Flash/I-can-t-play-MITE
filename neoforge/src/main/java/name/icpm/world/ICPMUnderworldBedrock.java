...
public final class ICPMUnderworldBedrock {
    ...
    /** 由 ICPMEventHandlers 在 NeoForge ChunkEvent.Load 中调用（替代原 Fabric CHUNK_LOAD）。 */
    public static void onChunkLoad(ServerLevel world, net.minecraft.world.level.chunk.LevelChunk chunk) {
